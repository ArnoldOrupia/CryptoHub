...
public class Currency_Adapter extends RecyclerView.Adapter<Currency_Adapter.MyViewHolder> {
    ...
    ///URL for getting the price rate of bitcoins
    public String BTC_URL = "https://min-api.cryptocompare.com/data/price?fsym=BTC&tsyms=";

    //URL for getting the price rate of ethereum
    public String ETH_URL = "https://min-api.cryptocompare.com/data/price?fsym=ETH&tsyms=";
    Resources res;
                                        ...
                                        public void response(HttpResponse response) {
                                            if (response.code == 200) {
                                             ...
                                             //   Toast.makeText(mContext, card_count+""+currencyList.size() +response.body, Toast.LENGTH_LONG).show();
                                                ...
                                                Toast.makeText(mContext, "Kindly check your internet connection!", Toast.LENGTH_LONG).show();
                                            }
                                        }
                                    }).execute();
    ...
    * It's optional but just to improve userbility we want to open the conversion page on any point clicked*/
    ...
    // Showing popup main_menu when tapping on 3 dots
   ...
   //  Click listener for popup main_menu items
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            switch (menuItem.getItemId()) {
                ...
                case R.id.action_remove:
                    ...
                    //the shared preferenceListener method in home will refresh UI once an item has been deleted;
